//
//  mpi_pingpongdoublerampup.c
//
//  Example PingPong implementation with double values measuring the ramp up. 
...
//	by parameters. In this example the first pingpong is out of the average measurement.
...
main(int argc, char *argv[])  {
    ...
    if (rank == 0) {
        ...
        printf(" MSGsizebytes    = %12.4f\n",msgsizebytes);
        printf(" transferMSGtime = %12.4f ms\n",transferMSGtime*1e03);
